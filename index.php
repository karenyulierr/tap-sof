          ...
          <form id="addUserT">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                ...
                <input type="number" class="form-control" min="0" id="addUserScore" name="score" required>
              </div>
            </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Actualizar competidor</h5>
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="emailField" class="col-md-3 form-label">Número:</label>
              <div class="col-md-9">
                <input type="number" class="form-control" id="scoreUpdate" name="score">
              </div>
            </div>
